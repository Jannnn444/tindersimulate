...
class HomeController: UIViewController {
    ...
    // MARK: - Helpers
    func configureCards() {
        let user1 = User( name: "Jane Doe", age: 22, images: [UIImage(named: "jane1"), UIImage(named: "jane2")])
        let user2 = User(name: "Megan", age: 21, images: [UIImage(named: "kelly1"), UIImage(named: "kelly2")])
